...
cp Makefile_iMX_LINUX $SRCDIR/bridge
...
############################################################
# Setup iMX Linux environment
. /opt/fsl-imx-internal-xwayland/5.10-gatesgarth/environment-setup-cortexa72-cortexa53-crypto-poky-linux

############################################################
# Make the build
#
make -f Makefile_iMX_LINUX clean
make -f Makefile_iMX_LINUX all
